...
if("TRUE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /home/az/arena_ws/src/arena/utils/navigation/planners/recovery/clear_costmap_recovery)
  set(clear_costmap_recovery_DEVEL_PREFIX /home/az/arena_ws/devel/.private/clear_costmap_recovery)
  ...
  set(clear_costmap_recovery_INSTALL_PREFIX /home/az/arena_ws/install)
...
if(NOT "/home/az/arena_ws/src/arena/utils/navigation/planners/recovery/clear_costmap_recovery/include " STREQUAL " ")
  set(clear_costmap_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/home/az/arena_ws/src/arena/utils/navigation/planners/recovery/clear_costmap_recovery/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/az/arena_ws/src/arena/utils/navigation/planners/recovery/clear_costmap_recovery/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/az/arena_ws/devel/.private/clear_costmap_recovery/lib;/home/az/arena_ws/devel/lib;/opt/ros/noetic/lib)
