...
class SocialRelation(genpy.Message):
  _md5sum = "d1649d28f150a194ade778eaadf431e1"
...
string      TYPE_FRIENDSHIP = "friendship\""""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.strength,) = _get_struct_f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.track1_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.track1_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.track2_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.track2_id = str[start:end]
      return self
