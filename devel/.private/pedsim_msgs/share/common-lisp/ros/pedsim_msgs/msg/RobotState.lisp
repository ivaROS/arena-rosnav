...
(cl:defmethod cl:initialize-instance :after ((m <RobotState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pedsim_msgs-msg:<RobotState> is deprecated: use pedsim_msgs-msg:RobotState instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <RobotState>))
...
(cl:defmethod twist-val ((m <RobotState>))
