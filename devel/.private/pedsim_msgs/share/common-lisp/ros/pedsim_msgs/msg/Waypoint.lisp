...
(cl:defclass <Waypoint> (roslisp-msg-protocol:ros-message)
  ((name
   ...
   (radius
    ...
    :initform 0.0)
   (interaction_radius
    :reader interaction_radius
    :initarg :interaction_radius
    :type cl:float
    :initform 0.0))
)
...
(cl:ensure-generic-function 'interaction_radius-val :lambda-list '(m))
(cl:defmethod interaction_radius-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pedsim_msgs-msg:interaction_radius-val is deprecated.  Use pedsim_msgs-msg:interaction_radius instead.")
  (interaction_radius m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Waypoint>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'interaction_radius))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Waypoint>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'position) istream)
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'interaction_radius) (roslisp-utils:decode-single-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Waypoint>)))
  ...
  "0711f152cb4a80e128296762f14a6fbe")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Waypoint)))
  "Returns md5sum for a message object of type 'Waypoint"
  "0711f152cb4a80e128296762f14a6fbe")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Waypoint>)))
  ...
  (cl:format cl:nil "int8 BHV_SIMPLE = 0~%int8 BHV_SOURCE = 1~%int8 BHV_SINK = 2~%~%string name~%int8 type~%int8 behavior~%geometry_msgs/Point position~%float32 radius~%float32 interaction_radius~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Waypoint)))
  "Returns full string definition for message of type 'Waypoint"
  (cl:format cl:nil "int8 BHV_SIMPLE = 0~%int8 BHV_SOURCE = 1~%int8 BHV_SINK = 2~%~%string name~%int8 type~%int8 behavior~%geometry_msgs/Point position~%float32 radius~%float32 interaction_radius~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Waypoint>))
  ...
  (cl:list 'Waypoint
    ...
    (cl:cons ':interaction_radius (interaction_radius msg))
))
