...
class CompositeDetectedPersons(genpy.Message):
  _md5sum = "5d5e8c2b74ecc3110327d5e73cd9f79e"
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.elements:
        _x = val1.composite_detection_id
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _x = val1
        buff.write(_get_struct_3d().pack(_x.mean_confidence, _x.max_confidence, _x.min_confidence))
        _v1 = val1.pose
        _v2 = _v1.pose
        _v3 = _v2.position
        _x = _v3
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.composite_detection_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          val1.composite_detection_id = str[start:end]
        _x = val1
        start = end
        end += 24
        (_x.mean_confidence, _x.max_confidence, _x.min_confidence,) = _get_struct_3d().unpack(str[start:end])
        _v9 = val1.pose
        _v10 = _v9.pose
        _v11 = _v10.position
        _x = _v11
