...
struct CompositeDetectedPerson_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _composite_detection_id_type;
...
struct MD5Sum< ::spencer_tracking_msgs::CompositeDetectedPerson_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xb4ac8352149f5e42ULL;
  static const uint64_t static_value2 = 0x7f143b401e34816dULL;
};
...
struct Printer< ::spencer_tracking_msgs::CompositeDetectedPerson_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::spencer_tracking_msgs::CompositeDetectedPerson_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.composite_detection_id);
