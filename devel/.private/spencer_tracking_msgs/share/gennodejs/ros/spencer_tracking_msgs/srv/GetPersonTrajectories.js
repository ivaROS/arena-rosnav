...
class GetPersonTrajectoriesRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.string(obj.requested_ids, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.requested_ids = _arrayDeserializer.string(buffer, bufferOffset, null)
  ...
  static getMessageSize(object) {
    let length = 0;
    object.requested_ids.forEach((val) => {
  ...
  static messageDefinition() {
    ...
    return `
    string[] requested_ids           # The IDs of the tracks you are interested in getting the trajectories of. An empty array means all available tracks.
...
module.exports = {
  ...
  md5sum() { return '10ef2940a54e32bc600e3b09cb15ce70'; },
