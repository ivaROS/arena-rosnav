...
class CompositeDetectedPerson {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.string(obj.composite_detection_id, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.composite_detection_id = _deserializer.string(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.composite_detection_id);
  ...
  static md5sum() {
    ...
    return 'b4ac8352149f5e427f143b401e34816d';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.composite_detection_id !== undefined) {
      ...
      resolved.composite_detection_id = ''
    }
