...
class CategoricalAttribute(genpy.Message):
  _md5sum = "5532cab1a071685034cd6fae28718973"
  _type = "spencer_human_attribute_msgs/CategoricalAttribute"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string                  subject_id              # either an observation ID or a track ID (if information has been integrated over time); should be encoded in topic name
