...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SocialRelation>) ostream)
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'track1_id))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'track1_id))
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'track2_id))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'track2_id))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SocialRelation>) istream)
  "Deserializes a message object of type '<SocialRelation>"
    ...
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'track1_id) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'track1_id) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
    (cl:let ((__ros_str_len 0))
      (cl:setf (cl:ldb (cl:byte 8 0) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'track2_id) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'track2_id) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SocialRelation>)))
  ...
  "d1649d28f150a194ade778eaadf431e1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SocialRelation)))
  "Returns md5sum for a message object of type 'SocialRelation"
  "d1649d28f150a194ade778eaadf431e1")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SocialRelation>)))
  ...
  (cl:format cl:nil "string      type        # e.g. mother-son relationship, romantic relationship, etc.~%float32     strength    # relationship strength between 0.0 and 1.0~%~%string      track1_id~%string      track2_id~%~%~%# Constants for type (just examples at the moment)~%string      TYPE_SPATIAL  = \"spatial\"~%string      TYPE_ROMANTIC = \"romantic\"~%string      TYPE_PARENT_CHILD = \"parent_child\"~%string      TYPE_FRIENDSHIP = \"friendship\"~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SocialRelation)))
  "Returns full string definition for message of type 'SocialRelation"
  (cl:format cl:nil "string      type        # e.g. mother-son relationship, romantic relationship, etc.~%float32     strength    # relationship strength between 0.0 and 1.0~%~%string      track1_id~%string      track2_id~%~%~%# Constants for type (just examples at the moment)~%string      TYPE_SPATIAL  = \"spatial\"~%string      TYPE_ROMANTIC = \"romantic\"~%string      TYPE_PARENT_CHILD = \"parent_child\"~%string      TYPE_FRIENDSHIP = \"friendship\"~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SocialRelation>))
  (cl:+ 0
     ...
     4
     4 (cl:length (cl:slot-value msg 'track1_id))
     4 (cl:length (cl:slot-value msg 'track2_id))
))
