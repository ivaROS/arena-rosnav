...
class SocialRelation {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.string(obj.track1_id, buffer, bufferOffset);
    // Serialize message field [track2_id]
    bufferOffset = _serializer.string(obj.track2_id, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.track1_id = _deserializer.string(buffer, bufferOffset);
    // Deserialize message field [track2_id]
    data.track2_id = _deserializer.string(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.track1_id);
    length += _getByteLength(object.track2_id);
    return length + 16;
  }
