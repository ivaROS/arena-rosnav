...
struct potential_detections_
{
  ...
  _header_type header;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _scores_type;
  _scores_type scores;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _detections_type;
  ...
  _class_strings_type class_strings;
   ...
   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _pincer_obs_type;
...
bool operator==(const ::ford_msgs::potential_detections_<ContainerAllocator1> & lhs, const ::ford_msgs::potential_detections_<ContainerAllocator2> & rhs)
{
