...
struct PedTrajVec_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::ford_msgs::PedTraj_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ford_msgs::PedTraj_<ContainerAllocator> >> _ped_traj_vec_type;
...
bool operator==(const ::ford_msgs::PedTrajVec_<ContainerAllocator1> & lhs, const ::ford_msgs::PedTrajVec_<ContainerAllocator2> & rhs)
{
  return lhs.ped_traj_vec == rhs.ped_traj_vec;
}
