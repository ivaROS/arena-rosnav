...
struct SSDObjs_
{
  ...
  _avg_colors_type avg_colors;
   ...
   typedef std::vector< ::geometry_msgs::Point_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::geometry_msgs::Point_<ContainerAllocator> >> _clusters_type;
...
bool operator==(const ::ford_msgs::SSDObjs_<ContainerAllocator1> & lhs, const ::ford_msgs::SSDObjs_<ContainerAllocator2> & rhs)
{
