...
"""autogenerated by genpy from mbf_msgs/GetInterPathActionResult.msg. Do not edit."""
import codecs
import sys
...
class GetInterPathActionResult(genpy.Message):
  _md5sum = "d67aca1f3dee54d1f090431dcebfe886"
  _type = "mbf_msgs/GetInterPathActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mbf_msgs/GetInterPathResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetInterPathActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = mbf_msgs.msg.GetInterPathResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = mbf_msgs.msg.GetInterPathResult()
