...
"""autogenerated by genpy from mbf_msgs/GetInterPathActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class GetInterPathActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "mbf_msgs/GetInterPathActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mbf_msgs/GetInterPathFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetInterPathActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = mbf_msgs.msg.GetInterPathFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = mbf_msgs.msg.GetInterPathFeedback()
