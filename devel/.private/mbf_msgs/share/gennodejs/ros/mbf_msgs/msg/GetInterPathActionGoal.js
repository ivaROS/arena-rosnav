...
let GetInterPathGoal = require('./GetInterPathGoal.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class GetInterPathActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new GetInterPathGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GetInterPathGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += GetInterPathGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetInterPathActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = GetInterPathGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new GetInterPathGoal()
    }
...
module.exports = GetInterPathActionGoal;
