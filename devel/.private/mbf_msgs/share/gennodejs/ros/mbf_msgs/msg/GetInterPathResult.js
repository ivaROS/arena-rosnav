...
class GetInterPathResult {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GetInterPathResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetInterPathResult(null);
...
module.exports = GetInterPathResult;
