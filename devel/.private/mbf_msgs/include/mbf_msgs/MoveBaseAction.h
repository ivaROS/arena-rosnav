...
struct MD5Sum< ::mbf_msgs::MoveBaseAction_<ContainerAllocator> >
{
  ...
  {
    return "c694adfd188b941c2de8267bc024718d";
  }

  static const char* value(const ::mbf_msgs::MoveBaseAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc694adfd188b941cULL;
  static const uint64_t static_value2 = 0x2de8267bc024718dULL;
};
