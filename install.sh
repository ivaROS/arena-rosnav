...
# curl -sSL https://install.python-poetry.org | python3 - (tries to install poetry 2 which requires python 3.9)
...
echo ""
echo "curl https://raw.githubusercontent.com/ivaROS/arena-rosnav/dev/quad_gap/install2.sh | bash"
