...
set(MSG_I_FLAGS "-Impc_local_planner_msgs:/home/az/arena_ws/src/planners/mpc/mpc_local_planner_msgs/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/az/arena_ws/src/planners/mpc/mpc_local_planner_msgs/msg/StateFeedback.msg" NAME_WE)
add_custom_target(_mpc_local_planner_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "mpc_local_planner_msgs" "/home/az/arena_ws/src/planners/mpc/mpc_local_planner_msgs/msg/StateFeedback.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/az/arena_ws/src/planners/mpc/mpc_local_planner_msgs/msg/OptimalControlResult.msg" NAME_WE)
add_custom_target(_mpc_local_planner_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "mpc_local_planner_msgs" "/home/az/arena_ws/src/planners/mpc/mpc_local_planner_msgs/msg/OptimalControlResult.msg" "std_msgs/Header"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mpc_local_planner_msgs)
  install(CODE "execute_process(COMMAND \"/home/az/.cache/pypoetry/virtualenvs/arena-rosnav-fVe40LB9-py3.8/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mpc_local_planner_msgs\")")
  # install generated code
  install(
