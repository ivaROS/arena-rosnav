...
set(MSG_I_FLAGS "-ILfH:/home/az/arena_ws/src/planners/lflh/msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/az/arena_ws/src/planners/lflh/msg/Bspline.msg" NAME_WE)
add_custom_target(_LfH_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "LfH" "/home/az/arena_ws/src/planners/lflh/msg/Bspline.msg" "geometry_msgs/Point"
)
...
_generate_msg_cpp(LfH
  "/home/az/arena_ws/src/planners/lflh/msg/Bspline.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/LfH)
  install(CODE "execute_process(COMMAND \"/home/az/.cache/pypoetry/virtualenvs/arena-rosnav-fVe40LB9-py3.8/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/LfH\")")
  # install generated code
  install(
